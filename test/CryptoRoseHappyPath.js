...
contract('CryptoRose', function(accounts) {
  ...
  it("should be initialized with empty values", function() {
    return CryptoRose.deployed().then(function(instance) {
      ...
      return CryptoRoseInstance.getArticlesForSale();
    }).then(function(data){
  ...
  it("should let us sell a first article", function() {
    return CryptoRose.deployed().then(function(instance) {
      CryptoRoseInstance = instance;
      return CryptoRoseInstance.sellArticle(articleName1, articleDescription1, web3.toWei(articlePrice1, "ether"), {
        from: seller
      });
  ...
  it("should let us sell a second article", function() {
    return CryptoRose.deployed().then(function(instance) {
      CryptoRoseInstance = instance;
      return CryptoRoseInstance.sellArticle(articleName2, articleDescription2, web3.toWei(articlePrice2, "ether"), {
        from: seller
      });
    }).then(function(receipt) {
